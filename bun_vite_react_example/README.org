...
:PROPERTIES:
:CUSTOM_ID: counter-component-demo
:END:

This project includes a demonstration of a custom React hook and component:

- =useCounter= - A custom React hook that provides counter functionality
...
- =CounterComponent= - A React component that uses the =useCounter= hook
...
- =CounterPage= - A page that displays the Counter demonstration
